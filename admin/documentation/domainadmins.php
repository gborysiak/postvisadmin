  ...
  <tr>
    ...
    <td valign="top" class="main"><div id="main">
      <table width="100%" border="1" cellpadding="1" cellspacing="1" class="main">
        <tr>
          <td height="20" colspan="2" background="../../images/butonbackground.jpg" class="text style6">Select Category</td>
          </tr>
        <tr>
          <td width="21%" background="../../images/butonbackground.jpg" class="text"><table width="100%" border="1" cellpadding="1" cellspacing="1" class="sample">
            <tr class="main">
          ...
          <td width="79%" valign="top" class="text"><p><strong>Domain Admins</strong></p>
            <p>Domain Admins are administrators with limited access to their individual domains. They can manage their quarantine, and add and remove email addresses and aliases. </p>
            <p>Everytime a new domain is added a default domain admin of postmaster@domain.tld is added. </p>
            <p>You can add more for a particular domain, or add more than the default superadmin. You can also deactivate domain admins if you wish if their accounts are past due etc.</p></td>
        </tr>
      </table>
      <br />
    </div></td>
