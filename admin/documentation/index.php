    ...
    <td valign="top" class="main"><div id="main">
      <table width="100%" border="1" cellpadding="1" cellspacing="1" class="main">
        ...
        <tr>
          ...
          <td width="79%" valign="top" class="text"><p>Welcome to the PostVis Admin help section.</p>
            <p>Here you will find information on the different areas of PostVis Admin and what they do. Any suggestions or comments, please email : <a href="mailto:rogersmith@lazytechs.com">rogersmith@lazytechs.com</a></p>            </td>
        </tr>
      </table>
      <br />
    </div></td>
