    ...
    <td valign="top" class="main"><div id="main">
      <table width="100%" border="1" cellpadding="1" cellspacing="1" class="main">
        ...
        <tr>
          ...
          <td width="79%" valign="top" class="text"><p><strong>Mail History</strong></p>
            <p>The mail history page will show you the top 20 domains that have been quarantined with their average score, and the top 20 clean domains with their average score. It will also show you the emails going through in the last two minutes.</p></td>
        </tr>
      </table>
      <br />
    </div></td>
