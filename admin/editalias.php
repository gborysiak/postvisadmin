...
if (isset($error)) {	
	...
	echo "<div style='color:#FF0000' class='text'><center>$error</center></div>";
...
?>
	...
	<form id="form1" name="form1" method="post" action="">
      <table width="50%" border="0" align="center" class="main">
        <tr>
          <td colspan="2" bgcolor="#003366"><div align="center" class="text style1"><strong>Edit Alias </strong></div></td>
        </tr>
        <tr>
          <td width="40%" background="/images/butonbackground.jpg" class="text">Email Address:</td>
          <td width="60%" class="text"><? echo $aliasinfo->address; ?></td>
        </tr>
        <tr>
