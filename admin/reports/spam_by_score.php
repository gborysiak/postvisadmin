  ...
  <tr>
    ...
    <td valign="top" class="main"><div id="main"><br />
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="3" bgcolor="#003366" class="boldtext"><div align="center" class="boldwhitetext style6"><span class="boldwhitetext">Spam by Score</span></div></td>
        </tr>
        <tr>
...
if ($dbconfig == "mysqli") {
	...
	$result = $mysqli->query($query_top_spam_scores);
	...
	$result = mysql_query($query_top_spam_scores);
