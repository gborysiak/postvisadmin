        ...
        <td colspan="2" bgcolor="#003366"><div align="center" class="boldwhitetext">
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="main">
            <tr>
			 ...
			 if ($_GET['format'] == 'html') {
			 	echo "<a href='/admin/messageviewall.php?mail_id=".$mail_id."&format=plain'><img src='/images/text.png' width='73' height='14' border=0/></a>";
				} elseif ($_GET['format'] == 'plain') {
					echo "<a href='/admin/messageviewall.php?mail_id=".$mail_id."&format=html'><img src='/images/html.png' width='73' height='14' border=0/></a>";
				}
				?>
